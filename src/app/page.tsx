          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className=" relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className=" absolute  w-28 left-0 -top-20 hidden lg:block ">
                <img src="/snake-1.png" className="w-full" alt="snanke img " />
              </div>
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Turn your cherished moments into a masterpiece with your own
                <span className="font-semibold"> one-of-a-kind</span> phone
                case. At Casetify, we believe in safeguarding your memories, not
                just your phone. Make every glance at your phone a trip down
                memory lane.
              </p>
        ...
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900 ">
                ...
                <span className=" relative px-2 bg-green-600 text-white rounded-md py-1">
                  your own case
                </span>{" "}
                now
              </h2>
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            <li className="w-fit">
              ...
              Premium silicone material for durability
            </li>
            <li className="w-fit">
              <Check className="h-5 w-5 text-green-600 inline mr-1.5" />
              Shock-absorbent design for superior protection
            </li>
            <li className="w-fit">
              <Check className="h-5 w-5 text-green-600 inline mr-1.5" />
